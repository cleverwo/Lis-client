...
@Form.create()
export default class DeviceAlarm extends Component {
  // 查看报警详情modal显示
  ...
  componentWillMount() {
    const { dispatch } = this.props;
    dispatch({
      type: 'alarm/fetchDeviceAlarmList',
    });
  }
            ...
            <FormItem label="报警类型">
              {getFieldDecorator('alarmInformation')(
                <Select placeholder="请选择" style={{width: '100%'}}>
                  <Option key="POWER_DOWN" value="水表掉电">
                    水表掉电
                  </Option>
                  <Option key="TRANSDUCER_FAULT" value="传感器故障">
                    传感器故障
                  </Option>
                  <Option key="VALVE_FAULT" value="阀门故障">
                    阀门故障
                  </Option>
                  <Option key="OPEN_VALVE" value="强制开阀">
                    强制开阀
                  </Option>
                  <Option key="OVERDRAW" value="透支">
                    透支
                  </Option>
                  <Option key="WATER_ALARM" value="水量告警">
                    水量告警
                  </Option>
                  <Option key="BATTERY_VOLTAGE" value="电池电压低">
                    电池电压低
                  </Option>
                  <Option key="DOWN_VALVE" value="关阀状态">
                    关阀状态
                  </Option>
                  <Option key="WRONG_METER" value="水表读数错误">
                    水表读数错误
                  </Option>
                  <Option key="OTHER_ALARM" value="其他报警类型">
                    其他报警类型
                  </Option>
                </Select>
              )}
