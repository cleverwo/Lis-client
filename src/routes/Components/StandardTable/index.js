...
class StandardTable extends PureComponent {
  ...
  render() {
    ...
    const { data: { list, pagination }, loading, columns, rowKey, noSelect, scroll } = this.props;
    ...
    const rowSelection = {
      ...
      getCheckboxProps: record => ({
        disabled: record.customerName !== undefined,
      }),
    };

    let divStyle = null;
    let rowSelectionProp = { rowSelection: rowSelection };
    if (noSelect) {
